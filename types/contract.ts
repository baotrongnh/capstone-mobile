...
export type ContractListResponse = paths["/api/v1/contracts"]["get"]["responses"]["200"]["content"]["application/json"]
...
export type ContractStatus = "draft" | "active" | "signed" | "terminated" | "renewal"
